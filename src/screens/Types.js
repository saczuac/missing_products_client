...
class Types extends React.Component {
    ...
    pushTopTabsScreen = () => {
        this.props.navigator.push({
            screen: 'mp.Types.TopTabs',
            title: 'Top Tabs',
            topTabs: [{
                screenId: 'mp.Types.TopTabs.TabOne',
                title: 'Tab One',
            }, {
                screenId: 'mp.Types.TopTabs.TabTwo',
                title: 'Tab Two',
            }],
        });
    };
